...
<head>  
    ...
    <style>  
        ...
        td {text-align:center; padding:5px; background:#999999; }  
        img {border:5px solid #303030; padding:0; verticle-align: middle;}  
        img:hover { border-color:#009900; cursor:pointer; }  
    </style>  
...
//		echo "a";
  //      continue;  
    ...
    $thumbSrc =  str_replace(" ","%20",$url."uploads/".$file);  
	//echo $thumbSrc."<br>";
    ...
    $str = sprintf('<img src="%s" width="%d" height="%d" title="" alt="">',   
        $thumbSrc,  
        $width,  
        $height
    );  
