        ...
        <div class="container">
        	...
        	<div class="leftcol">
            	...
            	<div class="district-news">
                	<!-- start imgb -->
					<?php if($main_article || $all_articles){?>
                	<div class="imgb">
                    	<a href="<?php echo base_url().$main_article['url'];?>" title=""><img src="<?php echo base_url().$main_article['art_image'];?>" alt="district image" /></a>
                    </div>
                    <!-- end imgb -->
                    <!-- start txtb -->
                	<div class="txtb common-news">
                    	<ul>
							<?php 
							echo '<li class="active"><a href="'.base_url().$main_article['url'].'" title="'.$main_article['title'].'">'.$main_article['title'].'</a></li>';
					...
					<?php
						...
						echo "<br/><br/><div class='city-news'><h3>इस स्थान के लिए कोई खबर नहीं है</h3></div><br/><br/><br/><br/>";
					}
                ...
                <div class="col1">
                	...
                	<div class="common-news">
                        <ul>
                        	<li class="active"><a href="#" title="ISI का मिशन 'हनी ट्रैप', बचके रहना">ISI का मिशन 'हनी ट्रैप', बचके रहना</a></li>
                            <li><a href="#" title="इस साल देश में सूखे के आसार!">इस साल देश में सूखे के आसार!</a></li>
                            <li><a href="#" title="इनका कॉन्फिडेंस आपको डुबो सकता है">इनका कॉन्फिडेंस आपको डुबो सकता है</a></li>
                            <li><a href="#" title="प्यार में अंधी’ मां ने ली बच्ची की जान">प्यार में अंधी’ मां ने ली बच्ची की जान</a></li>
                            <li><a href="#" title="जल्द करें लोकपाल की नियुक्ति: अन्‍ना">जल्द करें लोकपाल की नियुक्ति: अन्‍ना</a></li>
                            <li><a href="#" title="ISI का मिशन 'हनी ट्रैप', बचके रहना">ISI का मिशन 'हनी ट्रैप', बचके रहना</a></li>
                            <li><a href="#" title="इस साल देश में सूखे के आसार!">इस साल देश में सूखे के आसार!</a></li>
                            <li><a href="#" title="इनका कॉन्फिडेंस आपको डुबो सकता है">इनका कॉन्फिडेंस आपको डुबो सकता है</a></li>
                            <li><a href="#" title="प्यार में अंधी’ मां ने ली बच्ची की जान">प्यार में अंधी’ मां ने ली बच्ची की जान</a></li>
                            <li><a href="#" title="जल्द करें लोकपाल की नियुक्ति: अन्‍ना">जल्द करें लोकपाल की नियुक्ति: अन्‍ना</a></li>
                    ...
                    <!-- end common news -->
                    <!-- start ads5 -->
                    <div class="ads5 ad_clicked">
						
                    	<img src="images/img_ads5.jpg" alt="ad image" />
                    </div>
                    <!-- end ads5 -->
                </div>
                <!-- end col1 -->
