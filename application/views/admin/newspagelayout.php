		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="box">
						...
						<!-- body starts-->
						<div class="col-md-8">
							<div class="col-md-12 region">Detailed news
							...
							<div class="col-md-12 region">Related News</div>
							...
							<div class="col-md-12 region">Add Comment section</div>
							<div class="col-md-12 region">List of comments</div>
							<div class="col-md-12 region">Advertisement 7<br />
								<select class="form-control" name="ad_7">
										<?php
											foreach($ads as $ad) {
												if($ad['id']==$regions['ad_7'])
														echo '<option selected value="'.$ad['id'].'">'.$ad['title'].'</option>';
													else
														echo '<option value="'.$ad['id'].'">'.$ad['title'].'</option>';
											}
						...
						<div class="col-md-4 ">
							<div class="col-md-12 region">Select from Map </div>
							<div class="col-md-12 region">Poll </div>
