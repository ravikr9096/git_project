						...
						<table id="example1" class="table table-bordered table-hover">
							...
							<tbody>
								<?php
									$i=1;
									if($comments_data) {
										foreach($comments_data as $poll) {
											
										?>
										<tr>
											<td><?php echo $poll['id'];?></td>
											<td><?php echo $poll['art_id'];?></td>
											<td><?php echo $poll['comment'];?></td>
											<td><?php echo $this->common->getSingleValue('tbl_users','user_name','id',$poll['user_id']);?></td>
											...
											<td>
											<?php if(access_check('comments_read') || access_check('comments_update') ):?>
											...
											<?php endif;?>
											<?php if(access_check('comments_update')):?>
											<!--<a href="<?php echo base_url();?>index.php/adminPolls/edit_comment/<?php echo $poll['id']; ?>" title="Edit"><img src="<?php echo base_url(); ?>assets/admin/img/edit.png" /></a>&nbsp;&nbsp;-->
											<?php endif;?>
											<?php if(access_check('comments_delete')):?>
												<a onclick="return checkDelete();" href="<?php echo base_url();?>index.php/adminComments/delete_comment/<?php echo $poll['id']; ?>" title="Delete"><img src="<?php echo base_url(); ?>assets/admin/img/delete.png" /></a>
											<?php endif;?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Preview Comment</h4>
		...
		<div class="row">
				...
				<div class="box">
					...
					<div class="form-group">
                        <label><?php echo $this->common->getSingleValue('tbl_users','user_name','id',$poll['user_id']);?></label>
						<div >
						<?php echo $poll['comment'];?>
						</div>
