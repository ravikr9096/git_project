...
<html class="bg-black">
    <head>
        <meta charset="UTF-8">
        <title>Hindi Gaurav Admin Login Panel</title>
        ...
        <div class="form-box" id="login-box">
			...
			?>
                ...
                <div class="footer">                                                               
                    ...
                    <p><a href="<?php echo base_url();?>index.php/admin/password_send">I forgot my password</a></p>
