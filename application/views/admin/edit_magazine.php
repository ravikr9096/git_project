		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="col-md-6">
						<label>Images</label>
						<form method="post" action="<?php echo base_url()?>EMagazine/image_mag_update/<?php echo $mag['id'];?>">
						<div style="clear:both;"></div>
						<?php
							foreach($slider_images1 as $img) {
								echo '<div class="thumb_img" id="img_div_'.$img['id'].'"><img src="'.base_url().$img['path'].'" alt="'.$img['id'].'"><input type="hidden" name="img_arr[]" value="'.$img['id'].'"><br><label>Page no: </label>&nbsp;&nbsp;<input style=" display: inline;width: 50px;" type="text" name="img_arr_sort['.$img['id'].']" value="'.$img['sort'].'"><br><a href="#" onclick="remove_image('.$img['id'].');return false;">Remove</a></div>';
							}
...
<!-- pop up for add advertisement -->
        ...
        <div class="row">
                 ...
                 <div class="box">
            <form method="post" action="<?php echo base_url(); ?>EMagazine/save_mag_image/<?php echo $mag['id'];?>" enctype="multipart/form-data">     
