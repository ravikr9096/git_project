		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<?php echo form_open('adminUsers/save_user');?>
					<div class="form-group">
						<?php echo form_label('Username','user_name');?><span class="errors">*</span>
						<?php
							$data = array(
								'name'        => 'user_name',
								'id'          => 'user_name',
				...
				<div class="box-footer" style="margin-left: 60px; margin-top:-55px;"><a href="<?php echo base_url();?>index.php/adminUsers/show_users" tabindex="6"><button class='btn btn-primary'>Cancel</button></a></div>
			</div>
